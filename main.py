...
def attack(char_name: str, char_class: str) -> str:
    """Описываем сколько урона было нанесено определенным классом."""
...
def defence(char_name: str, char_class: str) -> str:
    """Сколько урона было заблокированно определенным классом."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применение специального оружия для классов."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор и подтверждение определенного класса."""
    approve_choice: str = ''
    char_class: str = ''
